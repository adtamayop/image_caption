...
# se prepara el tokenizer con el set de entrenamiento
...
# load test set
filename = 'C:/Users/atamayop/Desktop/image_caption/data/Flickr_8k.testImages.txt'
test = load_set(filename)
print('Dataset: %d' % len(test))
# descriptions
test_descriptions = load_clean_descriptions('C:/Users/atamayop/Desktop/image_caption/src/files/descriptions.txt', test)
print('Descriptions: test=%d' % len(test_descriptions))
# photo features
test_features = load_photo_features('C:/Users/atamayop/Desktop/image_caption/src/files/features.pkl', test)
print('Photos: test=%d' % len(test_features))

# load the model
filename = 'C:/Users/atamayop/Desktop/image_caption/src/model/model_3.h5'
